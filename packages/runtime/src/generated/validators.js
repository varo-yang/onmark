...
const schema61 = {"const":6,"description":"Version of the native-to-browser message contract.","format":"uint16","maximum":65535,"minimum":0,"type":"integer"};
...
if(4 !== data13){
const err29 = {instancePath:instancePath+"/timelineVersion",schemaPath:"#/properties/timelineVersion/const",keyword:"const",params:{allowedValue: 4},message:"must be equal to constant"};
if(vErrors === null){
vErrors = [err29];
}
else {
...
const schema75 = {"const":6,"description":"Version of the native-to-browser message contract.","format":"uint16","maximum":65535,"minimum":0,"type":"integer"};
