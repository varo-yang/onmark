...
const schema64 = {"const":8,"description":"Version of the native-to-browser message contract.","format":"uint16","maximum":65535,"minimum":0,"type":"integer"};
...
/*# sourceURL="https://onmark.dev/schemas/browser-request-v8.schema.json" */;
let vErrors = null;
let errors = 0;
...
if(8 !== data2){
const err8 = {instancePath:instancePath+"/version",schemaPath:"#/$defs/ProtocolVersion/const",keyword:"const",params:{allowedValue: 8},message:"must be equal to constant"};
if(vErrors === null){
vErrors = [err8];
}
else {
...
const schema78 = {"const":8,"description":"Version of the native-to-browser message contract.","format":"uint16","maximum":65535,"minimum":0,"type":"integer"};
...
/*# sourceURL="https://onmark.dev/schemas/browser-response-v8.schema.json" */;
let vErrors = null;
let errors = 0;
