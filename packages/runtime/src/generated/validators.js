...
const schema33 = {"additionalProperties":false,"description":"Timeline facts consumed by the Gate-one browser clock and presentation.","properties":{"evaluation":{"$ref":"#/$defs/WireInterval"},"frameRate":{"$ref":"#/$defs/WireFrameRate"},"output":{"$ref":"#/$defs/WireInterval"},"timelineVersion":{"const":1,"format":"uint16","maximum":65535,"minimum":0,"type":"integer"},"videos":{"items":{"$ref":"#/$defs/BrowserVideo"},"type":"array"}},"required":["timelineVersion","frameRate","evaluation","output","videos"],"type":"object"};
...
const err20 = {instancePath:instancePath+"/videos",schemaPath:"#/properties/videos/type",keyword:"type",params:{type: "array"},message:"must be array"};
if(vErrors === null){
vErrors = [err20];
}
else {
