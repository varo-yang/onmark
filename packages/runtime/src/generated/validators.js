...
const schema39 = {"description":"Closed overlay roles understood by the Gate-one presentation.","oneOf":[{"const":"title","description":"Authored title content.","type":"string"},{"const":"callToAction","description":"Authored call-to-action content.","type":"string"},{"const":"caption","description":"Imported caption text.","type":"string"}]};
...
if(typeof data1 !== "string"){
const err8 = {instancePath:instancePath+"/kind",schemaPath:"#/$defs/BrowserOverlayKind/oneOf/2/type",keyword:"type",params:{type: "string"},message:"must be string"};
if(vErrors === null){
vErrors = [err8];
}
else {
...
if("caption" !== data1){
const err9 = {instancePath:instancePath+"/kind",schemaPath:"#/$defs/BrowserOverlayKind/oneOf/2/const",keyword:"const",params:{allowedValue: "caption"},message:"must be equal to constant"};
if(vErrors === null){
vErrors = [err9];
}
else {
...
if(!valid2){
const err10 = {instancePath:instancePath+"/kind",schemaPath:"#/$defs/BrowserOverlayKind/oneOf",keyword:"oneOf",params:{passingSchemas: passing0},message:"must match exactly one schema in oneOf"};
if(vErrors === null){
vErrors = [err10];
}
else {
...
const err11 = {instancePath:instancePath+"/text",schemaPath:"#/properties/text/maxLength",keyword:"maxLength",params:{limit: 65536},message:"must NOT have more than 65536 characters"};
if(vErrors === null){
vErrors = [err11];
}
else {
