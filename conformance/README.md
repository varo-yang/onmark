...
Authored `.onmark` inputs are maintained by hand. Expected `.ast.txt` and
`.diagnostics.txt` files are generated golden artifacts and are not wire
formats or protocol schemas.
